...
public class TfIdfH {
	...
	public TfIdfH(ArrayList<Document> formatTrainDoc, ArrayList<Document> formatTestDoc, ArrayList<wordUnit> allWords){
	...
	public void calculateWeight(){
		for(int i = 0; i < allWords.size(); i++){
			...
			allWords.get(i).weight = allWords.get(i).weight / Math.sqrt(totalTf * allWords.get(i).weight);
			allWords.get(i).weight = allWords.get(i).weight * classEntropy * innerEntropy;
		}
	}
