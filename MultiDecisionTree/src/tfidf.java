...
public class tfidf {
	...
	public tfidf(ArrayList<Document> formatTrainDoc, ArrayList<Document> formatTestDoc, ArrayList<wordUnit> allWords){
	...
	public void calculateWeight(){
		for(int i = 0; i < allWords.size(); i++){
			...
			//double classEntropy = 2 + infoEntropy(allWords.get(i).tfc[0], allWords.get(i).tfc[1], allWords.get(i).tfc[2], allWords.get(i).tfc[3]);
			...
			allWords.get(i).weight = allWords.get(i).frequency * 1.0 * allWords.get(i).train_idf / allWords.size();
		}
	}	
