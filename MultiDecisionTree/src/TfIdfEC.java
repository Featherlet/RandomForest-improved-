...
public class TfIdfEC {
	...
	public TfIdfEC(ArrayList<Document> formatTrainDoc, ArrayList<Document> formatTestDoc, ArrayList<wordUnit> allWords){
	...
	public void calculateWeight(){
		for(int i = 0; i < allWords.size(); i++){
			...
			allWords.get(i).weight = allWords.get(i).frequency * 1.0 * allWords.get(i).train_idf * classEntropy * C;
		}
	}	
